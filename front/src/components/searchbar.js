        ...
        <div className='w-full h-fit bg-header-img p-16 flex flex-col align-middle justify-center'>
            <form className='flex flex-row justify-center'>
                ...
                <div class="relative w-4/5 md:w-3/5">
                    ...
                    <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 bg-gray-50 focus:ring-iut-green focus:border-iut-hover-green" placeholder="Search" required />
                </div>
