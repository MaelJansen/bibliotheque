 ...
 */
<<<<<<<< HEAD:back/migrations/Version20230327095926.php
final class Version20230327095926 extends AbstractMigration
========
final class Version20230327124212 extends AbstractMigration
>>>>>>>> 933b1cb (fix: :sparkles: Added grade entity and cleaned commands):back/migrations/Version20230327124212.php
{
...
<<<<<<<< HEAD:back/migrations/Version20230327095926.php
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, boocategory_id INT DEFAULT NULL, booeditor_id INT DEFAULT NULL, booname VARCHAR(2000) NOT NULL, boosummary VARCHAR(5000) DEFAULT NULL, boonb_pages INT DEFAULT NULL, boolink_img VARCHAR(5000) DEFAULT NULL, INDEX IDX_CBE5A331B68CE25F (boocategory_id), INDEX IDX_CBE5A331D3E0B119 (booeditor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
========
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, boocategory_id INT DEFAULT NULL, booeditor_id INT DEFAULT NULL, booname VARCHAR(2000) NOT NULL, boosummary VARCHAR(5000) DEFAULT NULL, boonb_pages INT DEFAULT NULL, boolink_img VARCHAR(5000) DEFAULT NULL, boopublish_date DATE DEFAULT NULL, INDEX IDX_CBE5A331B68CE25F (boocategory_id), INDEX IDX_CBE5A331D3E0B119 (booeditor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
>>>>>>>> 933b1cb (fix: :sparkles: Added grade entity and cleaned commands):back/migrations/Version20230327124212.php
        ...
        $this->addSql('CREATE TABLE grade (grabook_id INT NOT NULL, grauser_id INT NOT NULL, grarate INT NOT NULL, INDEX IDX_595AAE34996B50F6 (grabook_id), INDEX IDX_595AAE3428A730E2 (grauser_id), PRIMARY KEY(grabook_id, grauser_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
========
        $this->addSql('CREATE TABLE user_book (id INT AUTO_INCREMENT NOT NULL, usbuser_id INT NOT NULL, usbbook_id INT NOT NULL, usbdate_borrowed DATE NOT NULL, usbdate_given_back DATE DEFAULT NULL, INDEX IDX_B164EFF892087297 (usbuser_id), INDEX IDX_B164EFF823C41283 (usbbook_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
>>>>>>>> 933b1cb (fix: :sparkles: Added grade entity and cleaned commands):back/migrations/Version20230327124212.php
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A331B68CE25F FOREIGN KEY (boocategory_id) REFERENCES categories (id)');
        ...
        $this->addSql('ALTER TABLE grade ADD CONSTRAINT FK_595AAE34996B50F6 FOREIGN KEY (grabook_id) REFERENCES book (id)');
        $this->addSql('ALTER TABLE grade ADD CONSTRAINT FK_595AAE3428A730E2 FOREIGN KEY (grauser_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE user_user ADD CONSTRAINT FK_F7129A803AD8644E FOREIGN KEY (user_source) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_user ADD CONSTRAINT FK_F7129A80233D34C1 FOREIGN KEY (user_target) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_book ADD CONSTRAINT FK_B164EFF892087297 FOREIGN KEY (usbuser_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP FOREIGN KEY FK_CBE5A331B68CE25F');
        ...
        $this->addSql('ALTER TABLE grade DROP FOREIGN KEY FK_595AAE34996B50F6');
        $this->addSql('ALTER TABLE grade DROP FOREIGN KEY FK_595AAE3428A730E2');
        $this->addSql('ALTER TABLE user_user DROP FOREIGN KEY FK_F7129A803AD8644E');
        $this->addSql('ALTER TABLE user_user DROP FOREIGN KEY FK_F7129A80233D34C1');
        $this->addSql('ALTER TABLE user_book DROP FOREIGN KEY FK_B164EFF892087297');
